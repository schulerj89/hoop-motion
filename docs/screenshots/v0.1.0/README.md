...
- `viewer-fixture-jump-shot.png`: Three.js viewer with report and skeleton debug enabled.
- `animated-character-fixture-jump-shot.png`: canvas-only animated humanoid capture.
